...
//   return (
//     <section className="bg-[#A7BCB8] py-26 text-center">
//       <h2 className="text-4xl font-xl mb-16">
...
//                 <span key={i} className="text-teal-900 text-3xl">
//                   ★
//                 </span>
//               ))}
//             </div>
...
//             {/* Review */}
//             <p className="mb-6 text-gray-800 leading-relaxed font-semibold px-4 text-lg">
//               “{item.text}”
//             </p>
