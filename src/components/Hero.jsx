...
//   return (
//    <section
//   className="bg-gray-50 py-32 flex flex-col h-163 md:flex-row max-w-full bg-cover pl-30 items-center"
//   style={{
...
//         <p className="mb-8 text-white/90 pr-60">
