...
// const SectionCard = () => {
//   return (
//     <section className="grid grid-cols-2 bg-[#F0EBE5]">

//       {/* Row 1 */}
//       <div>
//         <img src={img1} alt="" className="w-full h-full object-cover " />
//       </div>
//       <div className="p-12 flex flex-col justify-center pl-30">
//         <h2 className="text-4xl mb-6">Improved Oral Health</h2>
//         <p className="mb-6 pr-65">
//           Maintain good oral hygiene by preventing tooth decay and reducing the risk of gum disease.
//         </p>
//         <button className="w-fit px-6 py-3 bg-[#104B4F] text-white hover:bg-teal-800">
//           Shop Now
//         </button>
//       </div>
...
//       {/* Row 2 */}
//       <div className="p-12 flex flex-col justify-center pl-30">
//         <h2 className="text-4xl mb-6">Enhanced Appearance</h2>
//         <p className="mb-6 pr-65">
...
//       </div>
//       <div className="p-12 flex flex-col justify-center pl-30">
//         <h2 className="text-4xl mb-6">Fresh Breath</h2>
//         <p className="mb-6 pr-65">
  ...
  return (
    <section className="grid grid-cols-2 auto-rows-fr bg-[#F0EBE5]">
      ...
      <div className="h-56 md:h-auto p-6 md:p-12 flex flex-col justify-center pl-6 md:pl-30">
        ...
        <p className="mb-3 md:mb-6 pr-4 md:pr-65 text-sm md:text-base">
          Maintain good oral hygiene by preventing tooth decay and reducing the risk of gum disease.
        </p>
