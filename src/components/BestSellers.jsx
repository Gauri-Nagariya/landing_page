...
//   return (
//     <section className="bg-[#A7BCB8] py-24 text-center">
      
//       <h2 className="text-4xl font-lg mb-4">
//         Explore our best-sellers
//       </h2>

//       <p className="text-gray-800 mb-16 max-w-xl mx-auto px-12">
...
//         {products.map((p, i) => (
//           <div key={i} className="bg-[#FAF7F2] p-6 transform cursor-pointer">
...
//             {/* Description */}
//             <p className="text-sm text-gray-700 mb-6 text-left pb-6">
//               {p.desc}
//             </p>

//             {/* Button */}
//             <button className="w-full bg-[#104B4F] text-white py-3 text-sm hover:bg-teal-800 cursor-pointer">
//               Shop Now
//             </button>
